...
<body>
    ...
    <script>
        ...
        const bounds = [[123.90100238675655, 32.622157846402175],[133.207154730507,39.40342567614195]];
        ...
        //TODO:지도 거리에 따라 표시할지 말지 선택하는 기능
        ...
        function addMarker(features) {
            features.forEach(element => {
                ...
                let popupHtml =
                    ...
                    <button id='addmarker' class='btn' onclick="addToListings('`+ element.properties.id + `')">목적지에 추가하기</button>`
                ;
        ...
        //저장된 리스트를 데이터베이스에 저장
        function loadSavedMapData(idx){
            //TODO:데이터 불러오기
            $.ajax({
                type: "post",
                url: "${cp}/map/routes/"+idx,
                // data: "data",
                // dataType: "dataType",
                beforeSend(jqXHR, settings) {
                    jqXHR.setRequestHeader('${_csrf.headerName}', '${_csrf.token}');
